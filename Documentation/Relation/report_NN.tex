...
\usepackage{sidecap}
\usepackage{hyperref}
\usepackage{titlesec}\usepackage{array}
...
\begin{table}[H]
	...
	\begin{tabular}{ |M{3.8cm}|M{2.5cm}|M{2.5cm}|M{2.5cm}|M{2.5cm}|M{2.5cm}| }
		\cline{2-6}
		\multicolumn{1}{c|}{}&	
		\multicolumn{4}{c|}{\large \textbf{NVIDIA GeForce RTX 2070 SUPER}}&
		\multicolumn{1}{M{2.5cm}|}{\large \textbf{NVIDIA GeForce GTX 1050-Ti}}\\
		\hline
...
\end{table}
%TODO: scrivere che abbiamo fatto la griglia per farne vedere di più
