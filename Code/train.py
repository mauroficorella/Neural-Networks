...
dataset = create_dataset(batch_size=BATCH_SIZE, folder=DATA_FOLDER, resolution=RESOLUTION,
...
test_images = get_test_images(test_input_size, DATA_FOLDER, RESOLUTION)
...
for epoch in range(EPOCHS):
    ...
    visualize_images_on_grid_and_save(epoch, generated_images, experiments_folder / "generated_images", 5, 5)
    ...
    visualize_images_on_grid_and_save(epoch, decoded_images, experiments_folder / "reconstructed_whole_images", 5, 5)
    visualize_images_on_grid_and_save(epoch, decoded_part_images, experiments_folder / "reconstructed_part_images", 5, 5)
